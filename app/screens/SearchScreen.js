...
import {users} from '../dataHelpers/users'
...
const InputInHeader = () => {
    ...
    <View style={styles.headerContainer}>
        ...
        <Button mode='contained' color={theme.colors.primary} style={styles.button} labelStyle={{color:theme.colors.background}}>Go</Button>
    </View>
    )
}
